...
//-TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  List<Story> _story = [
    Story('Want some water', 'choice1: yes',
        'choice2:no'),
    Story('Hungry Dog is staring at you, what will you do?', 'choice1: Give Food',
        'choice2: Run Away'),
    Story('Find 100 rupee note on road,what will you do?', 'choice1: keep it',
        'choice2: Find the owner'),
    Story('Story 3', 'choice1: this is the end', 'choice2: this is the end'),
    Story('Story 4', 'choice1: this is the end', 'choice2: this is the end'),
    Story('Hungry Dog is staring at you, what will you do?', 'choice1: Give Food',
        'choice2: Run Away'),
  ];
